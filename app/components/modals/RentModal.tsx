...
const RentModal = () => {
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Select the country the task is located in!"
        />
        <CountrySelect 
          value={location} 
  ...
  if (step === STEPS.IMAGES) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Add a photo for your task"
          subtitle="Choose an image that describes your task!"
        />
        <ImageUpload
  ...
  if (step === STEPS.PRICE) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Hooray!"
          subtitle="Select 'Create' to create your task"
        />
      </div>
    )
  }
